...
namespace school_rest_api.Functions.Queries
{
    public class GetStudentsByClassAndGroupQueryHandler : IRequestHandler<GetStudentsByClassAndGroupQuery, GetStudentsByClassAndGroupQueryResult>
    {
        ...
        public async Task<GetStudentsByClassAndGroupQueryResult> Handle(GetStudentsByClassAndGroupQuery request, CancellationToken cancellationToken)
        {
            ...
            return new GetStudentsByClassAndGroupQueryResult
            {
